                ...
                <div class="row top-part">
                    <div class="col-sm-3 col-md-3">
                        <a href="{{ lang_url('/') }}" class="logo-container">
                            <img src="{{asset('storage/images/logo.png')}}" sizes="30%" class="img-responsive logo" alt="{{ $head_title }}">
                        </a>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3" style="display: inline-flex;justify-content: right;align-items: center;gap: 20px;">
                        ...
                        <div class="user">
                            @auth
                                <p style="color:#3d5fcc;display:inline;">Hi! {{ Auth::user()->name }}</p>
        ...
        <footer>
            ...
            <div class="copy-rights">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-4">
                            Copyright {{ date('Y') }} Monir EL OUARROUDI | Ayoub Mchimach | Abdelghani AABA
                        </div>
                        <div class="col-sm-6 text-right">
                            All rights are reserved &copy; {{ date('Y') }}
                        </div>
                    </div>
                </div>
            </div>
