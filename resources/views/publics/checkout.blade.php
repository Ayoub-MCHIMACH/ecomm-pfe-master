            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="payment-types" style="display: flex;gap:10px;">
                    ...
                    <div class="box-type" data-radio-val="card" style="pointer-events: none;">
                        <img src="{{ asset('img/cards.png') }}" alt="econt" class="img-responsive" style="filter: grayscale(100%);">
                        <span>credit card (Soon)</span>
                    </div>
                    <div class="box-type" data-radio-val="paypal" style="pointer-events: none;">
                        <img src="{{ asset('img/paypal.png') }}" alt="econt" class="img-responsive" style="filter: grayscale(100%);">
                ...
                <form method="POST" action="{{lang_url('checkout')}}" id="set-order"> 
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <input class="form-control" name="name" value="@auth {{ Auth::user()->name }} @endauth" type="text" placeholder="{{__('public_pages.name')}}">
                        </div>
                        <div class="form-group col-sm-6">
                            <input class="form-control" name="email" value="@auth {{ Auth::user()->email }} @endauth" type="text" placeholder="{{__('public_pages.email_address')}}">
                        </div>
                        <div class="form-group col-sm-6">
                            <input class="form-control" name="phone" value="@auth {{ Auth::user()->phone }} @endauth" type="text" placeholder="{{__('public_pages.phone')}}">
                        </div>
                        <div class="form-group col-sm-12">
                            <textarea name="address" placeholder="{{__('public_pages.address')}}" class="form-control" rows="3">@auth {{ Auth::user()->address }} @endauth</textarea>
                        </div>
                        <div class="form-group col-sm-6">
                            <input class="form-control" name="city" value="@auth {{ Auth::user()->city }} @endauth" type="text" placeholder="{{__('public_pages.city')}}">
                        </div>
                        <div class="form-group col-sm-6">
                            <input class="form-control" name="post_code" value="@auth {{ Auth::user()->post_code }} @endauth" type="text" placeholder="{{__('public_pages.post_code')}}">
                        </div>
                        <div class="form-group col-sm-12">
